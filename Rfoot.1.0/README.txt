...
2. Obtain ribosome profiling dataset with cycloheximide treatment or without drug treatment, trim 3’ adapters of sequencing reads, map trimmed reads to rRNAs, and then align non-rRNA reads to the reference transcriptome and genome.
...
2b. Remove 3’ adapters of sequencing reads, using “removeAdapter.pl” from https://github.com/zhejilab/RibORF.
...
2e. Align trimmed ribosome profiling reads to rRNAs, and obtain non-rRNA reads.
...
-t transcriptFile: transcript annotation file in genePred format;
...
-f translatedORFFile [optional]: file with translated ORF annotation in genePred format. These regions will be excluded for the analyses of non-ribosomal protein-RNA complexes.

Example commands:
3a. Obtain human reference transcriptome annotation:
wget ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_28/gencode.v28.annotation.gtf.gz
Get gtfToGenePred command line from UCSC Genome Browser, and use the tool to convert the GTF file to genePred format:
